...
static const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |---------------------------------------------------------| |---------------|
     * |Caps |  Q|  W|  E|  R|  T|  Y|  U|Psc|Slk|Pau|  [|Ins|   | |  7|  8|  9|  -|
     * |-----------------------------------------------------'   | |---------------|
     * |Fn0   |  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;|  '|Return| |  4|  5|  6|  +|
     * |---------------------------------------------------------| |---------------|
     * |Shift   |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /|Shif|PgU| |  1|  2|  3|   |
     * |---------------------------------------------------------| |-----------|Ent|
     * |Alt  |Gui    |         Space         |Ctl|  \|Ctl|End|PgD| |      0|  .|   |
     * `---------------------------------------------------------' `---------------'
     */
    KEYMAP(
    ESC, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, DEL,     NLCK,EQL, PSLS,PAST,
    CAPS,Q,   W,   E,   R,   T,   Y,   U,   PSCR,SLCK,PAUS,LBRC,INS,          P7,  P8,  P9,  PMNS,
    FN0, A,   S,   D,   F,   G,   H,   J,   K,   L,   SCLN,QUOT,     ENT,     P4,  P5,  P6,  PPLS,
    LSFT,Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,          PGUP,    P1,  P2,  P3,  PENT,
    LALT,LGUI,               SPC,                LCTL,BSLS,LCTL,END, PGDN,    P0,       PDOT
    ),
};
